 ...
 * Use the [Fragment_getContactDetails.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment_getContactDetails : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_get_contact_details, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnNextOne = view.findViewById<Button>(R.id.navNxtBtnGetName)
    ...
    companion object {
         ...
         * @return A new instance of fragment Fragment_getContactDetails.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Fragment_getContactDetails().apply {
